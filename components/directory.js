  ...
  return (
    <> 
      <ul id="menu" className={styles.menu}>
        ...
        <li><a href="#"><span>connect_wallet</span></a></li>
        <li><a href="#"><span>purchase_add_on_uniswap</span></a></li>
        <li className={styles.disabled}><a href="#">{lock}<span>anarchy_dao</span></a></li>
        <li className={styles.disabled}><a href="#">{lock}<span>mint_nft</span></a></li>
        <li><a href="/manifesto"><span>manifesto</span></a></li>
        <li className={styles.disabled}><a href="#">{lock}<span>fr33d0m.mp4</span></a></li>
      </ul>
    </>
  )
}